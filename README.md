# rhel10_cis — Ansible role (rhel10-cis)
...
StigForge-exported Ansible role **`rhel10_cis`** · release **`0.3.0`**.
...
```bash
ansible-galaxy role install stigready.rhel10_cis,0.3.0
```
...
ansible-playbook -i inventory site.yml   # role: rhel10_cis
```
...
|---|---:|---:|---|---|---|
| `cis-l1` | **97.53%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260912T122819Z |
| `cis-l2` | **97.65%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260912T123033Z |
| `cis-ws-l1` | **97.53%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260912T123151Z |
| `cis-ws-l2` | **97.62%** ✓ | 90.0% | PASS ✓ | rc 0 | 20260912T123405Z |
