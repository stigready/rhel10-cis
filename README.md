...
StigForge-exported Ansible role **`rhel10_cis`** · release **`0.2.2-private-review`**.
...
```bash
ansible-galaxy role install stigready.rhel10_cis,0.2.2-private-review
```
...
|---|---:|---:|---|---|---|
| `cis-l1` | **92.0%** ✓ | 90.0% | PASS ✓ | rc 2 | 20260726T135946Z |
| `cis-l2` | **92.21%** ✓ | 90.0% | PASS ✓ | rc 2 | 20260726T140034Z |
